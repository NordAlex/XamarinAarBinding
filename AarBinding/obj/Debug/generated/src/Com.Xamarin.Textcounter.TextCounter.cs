...
namespace Com.Xamarin.Textcounter {
	...
	public partial class TextCounter : global::Java.Lang.Object {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/xamarin/textcounter/TextCounter", typeof (TextCounter));
		...
		public static unsafe int NumConsonants (string p0)
		{
		...
		public static unsafe int NumVowels (string p0)
		{
